...
struct name_and_function denemo_commands[] = {
 ...
 {CMD_CATEGORY_DIRECT, NULL, "Shifts the set of accidentals one step flatter", N_("FlattenEnharmonicSet"), "set_flatter", N_("Shift Accidentals Flatwise")}, 
  ...
  {CMD_CATEGORY_DIRECT, "GTK_STOCK_MEDIA_PLAY", "Play", N_("JackMidiPlay"), "jack_midi_playback", N_("JackMidiPlay")}, 
  {CMD_CATEGORY_DIRECT, "GTK_STOCK_MEDIA_STOP", "Stop", N_("JackMidiStop"), "stop_jack_midi_playback", N_("JackMidiStop")}, 
