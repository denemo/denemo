...
void go_to_A_key (DenemoAction* action, DenemoScriptParam *param);
void go_to_B_key (DenemoAction* action, DenemoScriptParam *param);
void go_to_C_key (DenemoAction* action, DenemoScriptParam *param);
void go_to_D_key (DenemoAction* action, DenemoScriptParam *param);
void go_to_E_key (DenemoAction* action, DenemoScriptParam *param);
void go_to_F_key (DenemoAction* action, DenemoScriptParam *param);
void go_to_G_key (DenemoAction* action, DenemoScriptParam *param);
...
gboolean add_tone_key (DenemoAction* action, DenemoScriptParam *param);
gboolean remove_tone_key (DenemoAction* action, DenemoScriptParam *param);
...
void stem_up (DenemoAction* action, DenemoScriptParam *param);
void stem_down (DenemoAction* action, DenemoScriptParam *param);
void flatten_key (DenemoAction* action, DenemoScriptParam *param);
