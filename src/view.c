...
#define DEF_SCHEME_CONST(which, what)\
  ...
  DEF_SCHEME_CONST("DENEMO_OVERRIDE_DYN_LILY", DENEMO_OVERRIDE_DYN_LILY);
  DEF_SCHEME_CONST("DENEMO_OVERRIDE_DYN_MIDI", DENEMO_OVERRIDE_DYN_MIDI);
  DEF_SCHEME_CONST("DENEMO_DYNAMIC_DIRECTIVE_MASK", DENEMO_DYNAMIC_DIRECTIVE_MASK);
