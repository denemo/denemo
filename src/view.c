...
GtkActionEntry menu_entries[] = {
  ...
  {"AddFiguredBass", NULL, N_("Add Figured Bass Staff..."), NULL,  N_("Not known to be useful"),
  ...
  {"StaffProperties", GTK_STOCK_PROPERTIES, N_("Properties"), NULL, N_("Change the properties of the current staff"), 
