...
tmp = g_strdup_printf("(define " #which " %d)\n", which);\
  ...
  DEF_OVERRIDE(DENEMO_OVERRIDE_CHANNEL);
  DEF_OVERRIDE(DENEMO_OVERRIDE_TEMPO);

  DEF_OVERRIDE(DENEMO_OVERRIDE_ONCE);
  DEF_OVERRIDE(DENEMO_OVERRIDE_STEP);
  DEF_OVERRIDE(DENEMO_OVERRIDE_RAMP);


  DEF_OVERRIDE(DENEMO_OVERRIDE_RELATIVE);
