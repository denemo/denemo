...
{"ToggleBeginSlur", NULL, N_("Begin Slur"), "",N_("Insert/delete begin slur on this note"),G_CALLBACK (toggle_begin_slur)},
{"ToggleEndSlur", NULL, N_("End Slur"), "",N_("Insert/delete end slur on this note"),G_CALLBACK (toggle_end_slur)},
...
{"Part-Combining", NULL, N_("Part-Combining"), "",N_("Menu:\nInstructions for the typesetter to do combine parts in various ways.")},
