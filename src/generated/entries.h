...
{"MeasureLeft", NULL, N_("Selection Measure Left"), "",N_("Moves the cursor to the first object in the next measure, extending selection if any"),G_CALLBACK (measureleft)},
{"MeasureRight", NULL, N_("Selection Measure Right"), "",N_("Moves the cursor to the first object in the previous measure, extending selection if any"),G_CALLBACK (measureright)},
