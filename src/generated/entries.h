...
{"InsertWholeRest", NULL, N_("Insert a \xF0\x9D\x84\xBB"), "",N_("Insert \xF0\x9D\x84\xBB rest"),G_CALLBACK (insert_rest_0key_cb)},
{"InsertHalfRest", NULL, N_("Insert a \xF0\x9D\x84\xBC"), "",N_("Insert \xF0\x9D\x84\xBC rest"),G_CALLBACK (insert_rest_1key_cb)},
{"InsertQuarterRest", NULL, N_("Insert a \xF0\x9D\x84\xBD"), "",N_("Insert \xF0\x9D\x84\xBD rest"),G_CALLBACK (insert_rest_2key_cb)},
{"InsertEighthRest", NULL, N_("Insert a \xF0\x9D\x84\xBE"), "",N_("Insert \xF0\x9D\x84\xBE rest"),G_CALLBACK (insert_rest_3key_cb)},
{"InsertSixteenthRest", NULL, N_("Insert a \xF0\x9D\x84\xBF"), "",N_("Insert \xF0\x9D\x84\xBF rest"),G_CALLBACK (insert_rest_4key_cb)},
{"InsertThirtysecondRest", NULL, N_("Insert a \xF0\x9D\x85\x80"), "",N_("Insert \xF0\x9D\x85\x80 rest"),G_CALLBACK (insert_rest_5key_cb)},
{"InsertSixtyfourthRest", NULL, N_("Insert a \xF0\x9D\x85\x81"), "",N_("Insert \xF0\x9D\x85\x81 rest"),G_CALLBACK (insert_rest_6key_cb)},
