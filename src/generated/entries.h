...
{"CursorLeft", NULL, N_("Cursor Left"), "",N_("Moves the cursor one object left, altering the selection if any"),G_CALLBACK (cursorleft)},
...
{"CursorRight", NULL, N_("Cursor Right"), "",N_("Moves the cursor one object right, altering the selection if any"),G_CALLBACK (cursorright)},
...
{"A", NULL, N_("Change/Append A"), "",N_("Changes the note the cursor is on to the note A.\nIf the cursor is in the appending position, appends a note using the prevailing duration."),G_CALLBACK (go_to_A_key)},
{"B", NULL, N_("Change/Append B"), "",N_("Changes the note the cursor is on to the note B.\nIf the cursor is in the appending position, appends a note using the prevailing duration."),G_CALLBACK (go_to_B_key)},
{"C", NULL, N_("Change/Append C"), "",N_("Changes the note the cursor is on to the note C.\nIf the cursor is in the appending position, appends a note using the prevailing duration."),G_CALLBACK (go_to_C_key)},
{"D", NULL, N_("Change/Append D"), "",N_("Changes the note the cursor is on to the note D.\nIf the cursor is in the appending position, appends a note using the prevailing duration."),G_CALLBACK (go_to_D_key)},
{"E", NULL, N_("Change/Append E"), "",N_("Changes the note the cursor is on to the note E.\nIf the cursor is in the appending position, appends a note using the prevailing duration."),G_CALLBACK (go_to_E_key)},
{"F", NULL, N_("Change/Append F"), "",N_("Changes the note the cursor is on to the note F.\nIf the cursor is in the appending position, appends a note using the prevailing duration."),G_CALLBACK (go_to_F_key)},
...
{"InsertTriplet", NULL, N_("Insert Triplet"), "",N_("Inserts a Start Triplet object and an End Tuplet object and places the cursor between these two"),G_CALLBACK (insert_triplet)},
{"StartTriplet", NULL, N_("Start Triplet"), "",N_("Inserts an Start Triplet object, which makes the notes following take 2/3 of their written duration. Later in this measure there should be an End Tuplet object."),G_CALLBACK (start_triplet)},
{"EndTuplet", NULL, N_("End Tuplet"), "",N_("Inserts an End Tuplet object, which terminates a tuplet started earlier in this measure."),G_CALLBACK (end_tuplet)},
{"InsertQuadtuplet", NULL, N_("Insert Quadruplet"), "",N_("No Tooltip yet"),G_CALLBACK (insert_quadtuplet)},
{"InsertQuintuplet", NULL, N_("Insert Quintuplet"), "",N_("No Tooltip yet"),G_CALLBACK (insert_quintuplet)},
{"InsertSextuplet", NULL, N_("Insert Sextuplet"), "",N_("No Tooltip yet"),G_CALLBACK (insert_sextuplet)},
{"InsertSeptuplet", NULL, N_("Insert Septuplet"), "",N_("No Tooltip yet"),G_CALLBACK (insert_septuplet)},
{"AddNoteToChord", NULL, N_("Add note"), "",N_("Add a note to the current chord\nThe cursor position determines which note to add"),G_CALLBACK (add_tone_key)},
{"RemoveNoteFromChord", NULL, N_("Remove note"), "",N_("Remove a note from the current chord, based on the cursor position"),G_CALLBACK (remove_tone_key)},
{"Sharpen", NULL, N_("Sharpen"), "",N_("Sharpen the note at the cursor"),G_CALLBACK (sharpen_key)},
{"Flatten", NULL, N_("Flatten"), "",N_("Flatten the note at the cursor"),G_CALLBACK (flatten_key)},
...
{"StemUp", NULL, N_("StemUp"), "",N_("Alters a StemNeutral object to stem up."),G_CALLBACK (stem_up)},
{"StemDown", NULL, N_("StemDown"), "",N_("Alters a StemNeutral object to stem down."),G_CALLBACK (stem_down)},
...
{"ToggleTie", NULL, N_("Tie (Off/On)"), "",N_("Ties/unties the note at the cursorm. The following note should be the same pitch."),G_CALLBACK (toggle_tie)},
...
{"InsertTrebleClef", NULL, N_("New Treble Clef"), "",N_("No Tooltip yet"),G_CALLBACK (newcleftreble)},
{"InsertBassClef", NULL, N_("New Bass Clef"), "",N_("No Tooltip yet"),G_CALLBACK (newclefbass)},
{"Insertg8clef", NULL, N_("New G8 Clef"), "",N_("No Tooltip yet"),G_CALLBACK (newclefg8)},
{"InsertAltoClef", NULL, N_("New Alto Clef"), "",N_("No Tooltip yet"),G_CALLBACK (newclefalto)},
{"InsertTenorClef", NULL, N_("New Tenor Clef"), "",N_("No Tooltip yet"),G_CALLBACK (newcleftenor)},
{"InsertSopranoClef", NULL, N_("New Soprano Clef"), "",N_("No Tooltip yet"),G_CALLBACK (newclefsoprano)},
{"SetInitialTrebleClef", NULL, N_("Set Treble Clef"), "",N_("No Tooltip yet"),G_CALLBACK (setcleftreble)},
{"SetInitialBassClef", NULL, N_("Set Bass Clef"), "",N_("No Tooltip yet"),G_CALLBACK (setclefbass)},
{"SetInitialg8clef", NULL, N_("Set G8 Clef"), "",N_("No Tooltip yet"),G_CALLBACK (setclefg8)},
{"SetInitialAltoClef", NULL, N_("Set Alto Clef"), "",N_("No Tooltip yet"),G_CALLBACK (setclefalto)},
{"SetInitialTenorClef", NULL, N_("Set Tenor Clef"), "",N_("No Tooltip yet"),G_CALLBACK (setcleftenor)},
{"SetInitialSopranoClef", NULL, N_("Set Soprano Clef"), "",N_("No Tooltip yet"),G_CALLBACK (setclefsoprano)},
...
{"InsertCmaj", NULL, N_("Insert Cmaj"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigcmaj)},
{"InsertGmaj", NULL, N_("Insert Gmaj"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysiggmaj)},
{"InsertDmaj", NULL, N_("Insert Dmaj"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigdmaj)},
{"InsertAmaj", NULL, N_("Insert Amaj"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigamaj)},
{"InsertEmaj", NULL, N_("Insert Emaj"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigemaj)},
{"InsertBmaj", NULL, N_("Insert Bmaj"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigbmaj)},
{"InsertFSharpmaj", NULL, N_("Insert F# Major"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigfsharpmaj)},
{"InsertCSharpmaj", NULL, N_("Insert C# Major"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigcsharpmaj)},
{"InsertFmaj", NULL, N_("Insert F Major"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigfmaj)},
{"InsertBflatmaj", NULL, N_("Insert Bb Major"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigbflatmaj)},
{"InsertEflatmaj", NULL, N_("Insert Eb Major"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigeflatmaj)},
{"InsertAflatmaj", NULL, N_("Insert Ab Major"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigaflatmaj)},
{"InsertDflatmaj", NULL, N_("Insert Db Major"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigdflatmaj)},
{"InsertGflatmaj", NULL, N_("Insert Gb Major"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysiggflatmaj)},
{"InsertCflatmaj", NULL, N_("Insert Cb Major"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigcflatmaj)},
{"InsertAmin", NULL, N_("Insert A Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigamin)},
{"InsertEmin", NULL, N_("Insert E Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigemin)},
{"InsertBmin", NULL, N_("Insert B Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigbmin)},
{"InsertFSharpmin", NULL, N_("Insert F# Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigfsharpmin)},
{"InsertCSharpmin", NULL, N_("Insert C# Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigcsharpmin)},
{"InsertGSharpmin", NULL, N_("Insert G# Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysiggsharpmin)},
{"InsertDSharpmin", NULL, N_("Insert D# Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigdsharpmin)},
{"InsertASharpmin", NULL, N_("Insert A# Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigasharpmin)},
{"InsertDmin", NULL, N_("Insert D Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigdmin)},
{"InsertGmin", NULL, N_("Insert G Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysiggmin)},
{"InsertCmin", NULL, N_("Insert C Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigcmin)},
{"InsertFmin", NULL, N_("Insert F Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigfmin)},
{"InsertBflatmin", NULL, N_("Insert Bb Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigbflatmin)},
{"InsertEflatmin", NULL, N_("Insert Eb Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigeflatmin)},
{"InsertAflatmin", NULL, N_("Insert Ab Minor"), "",N_("No Tooltip yet"),G_CALLBACK (newkeysigaflatmin)},
{"SetInitialCmaj", NULL, N_("Set Initial Keysig to C Major"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigcmaj)},
{"SetInitialGmaj", NULL, N_("Set Initial Keysig to G Major"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysiggmaj)},
{"SetInitialDmaj", NULL, N_("Set D Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigdmaj)},
{"SetInitialAmaj", NULL, N_("Set A Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigamaj)},
{"SetInitialEmaj", NULL, N_("Set E Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigemaj)},
{"SetInitialBmaj", NULL, N_("Set B Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigbmaj)},
{"SetInitialFSharpmaj", NULL, N_("Set F# Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigfsharpmaj)},
{"SetInitialCSharpmaj", NULL, N_("Set C# Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigcsharpmaj)},
{"SetInitialFmaj", NULL, N_("Set F Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigfmaj)},
{"SetInitialBflatmaj", NULL, N_("Set Bb Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigbflatmaj)},
{"SetInitialEflatmaj", NULL, N_("Set Eb Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigeflatmaj)},
{"SetInitialAflatmaj", NULL, N_("Set Ab Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigaflatmaj)},
{"SetInitialDflatmaj", NULL, N_("Set Db Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigdflatmaj)},
{"SetInitialGflatmaj", NULL, N_("Set Gb Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysiggflatmaj)},
{"SetInitialCflatmaj", NULL, N_("Set Cb Major as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigcflatmaj)},
{"SetInitialAmin", NULL, N_("Set A Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigamin)},
{"SetInitialEmin", NULL, N_("Set E Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigemin)},
{"SetInitialBmin", NULL, N_("Set B Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigbmin)},
{"SetInitialFSharpmin", NULL, N_("Set F# Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigfsharpmin)},
{"SetInitialCSharpmin", NULL, N_("Set C# Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigcsharpmin)},
{"SetInitialGSharpmin", NULL, N_("Set G# Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysiggsharpmin)},
{"SetInitialDSharpmin", NULL, N_("Set D# Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigdsharpmin)},
{"SetInitialASharpmin", NULL, N_("Set A# Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigasharpmin)},
{"SetInitialDmin", NULL, N_("Set D Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigdmin)},
{"SetInitialGmin", NULL, N_("Set G Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysiggmin)},
{"SetInitialCmin", NULL, N_("Set C Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigcmin)},
{"SetInitialFmin", NULL, N_("Set F Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigfmin)},
{"SetInitialBflatmin", NULL, N_("Set Bb Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigbflatmin)},
{"SetInitialEflatmin", NULL, N_("Set Eb Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigeflatmin)},
{"SetInitialAflatmin", NULL, N_("Set Ab Minor as Initial Keysig"), "",N_("No Tooltip yet"),G_CALLBACK (setkeysigaflatmin)},
...
{"InsertRhythm", NULL, N_("Insert Snippet"), "",N_("No Tooltip yet"),G_CALLBACK (insert_rhythm_pattern)},
...
{"VoiceUp", NULL, N_("Voice Up"), "",N_("Go to the higher numbered voice on staff, extending selection if any"),G_CALLBACK (voiceup)},
{"VoiceDown", NULL, N_("Voice Down"), "",N_("Go to the lower numbered voice on this staff, extending selection if any"),G_CALLBACK (voicedown)},
