...
static void insert_blankchord_7key_cb (GtkAction *action, gpointer param) {
  insert_blankchord_7key (Denemo.gui);
  displayhelper (Denemo.gui);
  score_status(Denemo.gui, TRUE);
}
