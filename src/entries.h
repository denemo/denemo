...
{"MoveToMeasureRight", NULL, N_("Move to Measure Right"), "",N_("Moves the cursor to the first object in the previous measureleaving selection, if any, unchanged"),G_CALLBACK (movetomeasureright_cb)},
{"A", NULL, N_("A"), "",N_("Append/Edit  A"),G_CALLBACK (go_to_A_key_cb)},
{"B", NULL, N_("B"), "",N_("Append/Edit  B"),G_CALLBACK (go_to_B_key_cb)},
{"C", NULL, N_("C"), "",N_("Append/Edit  C"),G_CALLBACK (go_to_C_key_cb)},
{"D", NULL, N_("D"), "",N_("Append/Edit  D"),G_CALLBACK (go_to_D_key_cb)},
{"E", NULL, N_("E"), "",N_("Append/Edit  E"),G_CALLBACK (go_to_E_key_cb)},
{"F", NULL, N_("F"), "",N_("Append/Edit  F"),G_CALLBACK (go_to_F_key_cb)},
{"G", NULL, N_("G"), "",N_("Append/Edit  G"),G_CALLBACK (go_to_G_key_cb)},
{"OctaveUp", NULL, N_("Octave Up"), "",N_("Octave Up"),G_CALLBACK (octave_up_key_cb)},
{"OctaveDown", NULL, N_("Octave Down"), "",N_("Octave Down"),G_CALLBACK (octave_down_key_cb)},
...
{"InsertWholeRest", NULL, N_("<span font_desc=\"Denemo\">\xF0\x9D\x84\xBB</span>"), "",N_("Insert \xF0\x9D\x84\xBB rest"),G_CALLBACK (insert_rest_0key_cb)},
{"InsertHalfRest", NULL, N_("<span font_desc=\"Denemo\">\xF0\x9D\x84\xBC</span>"), "",N_("Insert \xF0\x9D\x84\xBC rest"),G_CALLBACK (insert_rest_1key_cb)},
{"InsertQuarterRest", NULL, N_("<span font_desc=\"Denemo\">\xF0\x9D\x84\xBD</span>"), "",N_("Insert \xF0\x9D\x84\xBD rest"),G_CALLBACK (insert_rest_2key_cb)},
{"InsertEighthRest", NULL, N_("<span font_desc=\"Denemo\">\xF0\x9D\x84\xBE</span>"), "",N_("Insert \xF0\x9D\x84\xBE rest"),G_CALLBACK (insert_rest_3key_cb)},
{"InsertSixteenthRest", NULL, N_("<span font_desc=\"Denemo\">\xF0\x9D\x84\xBF</span>"), "",N_("Insert \xF0\x9D\x84\xBF rest"),G_CALLBACK (insert_rest_4key_cb)},
{"InsertThirtysecondRest", NULL, N_("<span font_desc=\"Denemo\">\xF0\x9D\x85\x80</span>"), "",N_("Insert \xF0\x9D\x85\x80 rest"),G_CALLBACK (insert_rest_5key_cb)},
{"InsertSixtyfourthRest", NULL, N_("<span font_desc=\"Denemo\">\xF0\x9D\x85\x81</span>"), "",N_("Insert \xF0\x9D\x85\x81 rest"),G_CALLBACK (insert_rest_6key_cb)},
{"InsertBlankWholeNote", NULL, N_("InsertBlankWholeNote"), "",N_("Insert a non-printing \xF0\x9D\x84\xBB rest"),G_CALLBACK (insert_blankchord_0key_cb)},
{"InsertBlankHalfNote", NULL, N_("InsertBlankHalfNote"), "",N_("Insert a non-printing \xF0\x9D\x84\xBC rest"),G_CALLBACK (insert_blankchord_1key_cb)},
{"InsertBlankQuarterNote", NULL, N_("InsertBlankQuarterNote"), "",N_("Insert a non-printing \xF0\x9D\x84\xBD rest"),G_CALLBACK (insert_blankchord_2key_cb)},
{"InsertBlankEighthNote", NULL, N_("InsertBlankEighthNote"), "",N_("Insert a non-printing \xF0\x9D\x84\xBE rest"),G_CALLBACK (insert_blankchord_3key_cb)},
{"InsertBlankSixteenthNote", NULL, N_("InsertBlankSixteenthNote"), "",N_("Insert a non-printing \xF0\x9D\x84\xBF rest"),G_CALLBACK (insert_blankchord_4key_cb)},
{"InsertBlankThirtysecondNote", NULL, N_("InsertBlankThirtysecondNote"), "",N_("Insert a non-printing \xF0\x9D\x85\x80 rest"),G_CALLBACK (insert_blankchord_5key_cb)},
{"InsertBlankSixtyfourthNote", NULL, N_("InsertBlankSixtyfourthNote"), "",N_("Insert a non-printing \xF0\x9D\x85\x81 rest"),G_CALLBACK (insert_blankchord_6key_cb)},
{"InsertBlankOneHundredTwentyEighthNote", NULL, N_("InsertBlankOneHundredTwentyEighthNote"), "",N_("Insert a non-printing \xF0\x9D\x85\x82 rest"),G_CALLBACK (insert_blankchord_7key_cb)},
{"InsertBlankTwoHundredFiftySixthNote", NULL, N_("InsertBlankTwoHundredFiftySixthNote"), "",N_("Insert a non-printing \xF0\x9D\x85\x83 rest"),G_CALLBACK (insert_blankchord_8key_cb)},
...
{"InsertTriplet", NULL, N_("Insert Triplet"), "",N_("No Tooltip yet"),G_CALLBACK (insert_triplet_cb)},
{"StartTriplet", NULL, N_("Start Triplet"), "",N_("No Tooltip yet"),G_CALLBACK (start_triplet_cb)},
{"EndTuplet", NULL, N_("End Tuplet"), "",N_("No Tooltip yet"),G_CALLBACK (end_tuplet_cb)},
{"InsertQuadtuplet", NULL, N_("Insert Quadtuplet"), "",N_("No Tooltip yet"),G_CALLBACK (insert_quadtuplet_cb)},
...
{"RemoveNoteFromChord", NULL, N_("Remove note"), "",N_("Remove a note from the current chord"),G_CALLBACK (remove_tone_key_cb)},
{"Sharpen", NULL, N_("Sharpen"), "",N_("No Tooltip yet"),G_CALLBACK (sharpen_key_cb)},
{"Flatten", NULL, N_("Flatten"), "",N_("No Tooltip yet"),G_CALLBACK (flatten_key_cb)},
...
{"AddDot", NULL, N_("Add Dot"), "",N_("No Tooltip yet"),G_CALLBACK (add_dot_key_cb)},
{"RemoveDot", NULL, N_("Remove Dot"), "",N_("No Tooltip yet"),G_CALLBACK (remove_dot_key_cb)},
...
{"AppendMeasure", NULL, N_("Staff Append Measure"), "",N_("No Tooltip yet"),G_CALLBACK (append_measure_key_cb)},
...
{"ToggleStartCrescendo", NULL, N_("Start Crescendo"), "",N_("No Tooltip yet"),G_CALLBACK (toggle_start_crescendo_cb)},
{"ToggleEndCrescendo", NULL, N_("End Crescendo"), "",N_("No Tooltip yet"),G_CALLBACK (toggle_end_crescendo_cb)},
{"ToggleStartDiminuendo", NULL, N_("Start Diminuendo"), "",N_("No Tooltip yet"),G_CALLBACK (toggle_start_diminuendo_cb)},
{"ToggleEndDiminuendo", NULL, N_("End Diminuendo"), "",N_("No Tooltip yet"),G_CALLBACK (toggle_end_diminuendo_cb)},
...
{"ForceCaution", NULL, N_("Force Cautionary Accidental"), "",N_("No Tooltip yet"),G_CALLBACK (force_cautionary_cb)},
{"ChangePitch", NULL, N_("Change Pitch"), "",N_("No Tooltip yet"),G_CALLBACK (change_pitch_cb)},
...
{"PrintPreview", GTK_STOCK_PRINT_PREVIEW, N_("Print Preview"), "",N_("Displays the final finished score in your pd viewer"),G_CALLBACK (printpreview_cb)},
...
{"StaffGroupings", NULL, N_("Staff Groupings (Braces)"), "",N_("Menu:\nVarious sorts of brace linking the staffs together. These may be nested, see the Score Lyout view for a display of the staff groups created.")},
