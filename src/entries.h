...
{"InsertBlankWholeNote", NULL, N_("\xF0\x9D\x84\xBB Spacer"), "",N_("Insert a non-printing \xF0\x9D\x84\xBB rest"),G_CALLBACK (insert_blankchord_0key_cb)},
{"InsertBlankHalfNote", NULL, N_("\xF0\x9D\x84\xBC Spacer"), "",N_("Insert a non-printing \xF0\x9D\x84\xBC rest"),G_CALLBACK (insert_blankchord_1key_cb)},
{"InsertBlankQuarterNote", NULL, N_("\xF0\x9D\x84\xBD Spacer"), "",N_("Insert a non-printing \xF0\x9D\x84\xBD rest"),G_CALLBACK (insert_blankchord_2key_cb)},
{"InsertBlankEighthNote", NULL, N_("\xF0\x9D\x84\xBE Spacer"), "",N_("Insert a non-printing \xF0\x9D\x84\xBE rest"),G_CALLBACK (insert_blankchord_3key_cb)},
{"InsertBlankSixteenthNote", NULL, N_("\xF0\x9D\x84\xBF Spacer"), "",N_("Insert a non-printing \xF0\x9D\x84\xBF rest"),G_CALLBACK (insert_blankchord_4key_cb)},
{"InsertBlankThirtysecondNote", NULL, N_("\xF0\x9D\x85\x80 Spacer"), "",N_("Insert a non-printing \xF0\x9D\x85\x80 rest"),G_CALLBACK (insert_blankchord_5key_cb)},
{"InsertBlankSixtyfourthNote", NULL, N_("\xF0\x9D\x85\x81 Spacer"), "",N_("Insert a non-printing \xF0\x9D\x85\x81 rest"),G_CALLBACK (insert_blankchord_6key_cb)},
{"InsertBlankOneHundredTwentyEighthNote", NULL, N_("\xF0\x9D\x85\x82 Spacer"), "",N_("Insert a non-printing \xF0\x9D\x85\x82 rest"),G_CALLBACK (insert_blankchord_7key_cb)},
{"InsertBlankTwoHundredFiftySixthNote", NULL, N_("\xF0\x9D\x85\x83 Spacer"), "",N_("Insert a non-printing \xF0\x9D\x85\x83 rest"),G_CALLBACK (insert_blankchord_8key_cb)},
