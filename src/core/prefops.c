...
#define ret (&Denemo.prefs)
  ...
  ret->graphicseditor = g_string_new (g_build_filename (get_system_bin_dir (), "inkscape.exe", NULL));       //We don't assume the file assoc works - we are guessing at the location of inkscape
