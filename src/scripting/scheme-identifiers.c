...
#include "generated/scheme.h"
  ...
  install_scm_function (0, "Returns the classification of the passed in duration(s)", DENEMO_SCHEME_PREFIX "Classify", scheme_classify);
  install_scm_function (4, "Trains the classifier on passed in training samples. Parameters are number of samples, number of input neurons, number of output neurons and a string of values", DENEMO_SCHEME_PREFIX "Train", scheme_train);
