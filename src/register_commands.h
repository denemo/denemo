...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "SaveCopy"), "SaveCopy", "Save Copy/Export", "Save a copy of the score or Export to a different format", file_copy_save);
