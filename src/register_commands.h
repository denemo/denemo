...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleAccent"), "ToggleAccent", "Add Accent", "No Tooltip yet", add_accent);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleFermata"), "ToggleFermata", "Add Fermata", "No Tooltip yet", add_fermata);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleStaccato"), "ToggleStaccato", "Add Staccato", "No Tooltip yet", add_staccato);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleTenuto"), "ToggleTenuto", "Add Tenuto", "No Tooltip yet", add_tenuto);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleTrill"), "ToggleTrill", "Add Trill", "No Tooltip yet", add_trill);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleTurn"), "ToggleTurn", "Add Turn", "No Tooltip yet", add_turn);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleMordent"), "ToggleMordent", "Add Mordent", "No Tooltip yet", add_mordent);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleStaccatissimo"), "ToggleStaccatissimo", "Add Staccatissimo", "No Tooltip yet", add_staccatissimo);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleCoda"), "ToggleCoda", "Add Coda", "No Tooltip yet", add_coda);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleFlageolet"), "ToggleFlageolet", "Add Flageolet", "No Tooltip yet", add_flageolet);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleOpen"), "ToggleOpen", "Add Open", "No Tooltip yet", add_open);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "TogglePrallMordent"), "TogglePrallMordent", "Add Prall Mordent", "No Tooltip yet", add_prallmordent);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "TogglePrallPrall"), "TogglePrallPrall", "Add Prall Prall", "No Tooltip yet", add_prallprall);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "TogglePrall"), "TogglePrall", "Add Prall", "No Tooltip yet", add_prall);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleReverseTurn"), "ToggleReverseTurn", "Add Reverse Turn", "No Tooltip yet", add_reverseturn);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleSegno"), "ToggleSegno", "Toggle Segno", "No Tooltip yet", add_segno);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleSforzato"), "ToggleSforzato", "Toggle Sforzato", "No Tooltip yet", add_sforzato);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleStopped"), "ToggleStopped", "Toggle Stopped", "No Tooltip yet", add_stopped);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleThumb"), "ToggleThumb", "Toggle Thumb", "No Tooltip yet", add_thumb);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleUpprall"), "ToggleUpprall", "Toggle Up Prall", "No Tooltip yet", add_upprall);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleArpeggio"), "ToggleArpeggio", "Add Apreggio", "No Tooltip yet", add_arpeggio);
...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "InsertKey"), "InsertKey", "Insert Key Change", "Insert a key change at the cursor position", key_change_insert);
...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "InsertLilyPostfix"), "InsertLilyPostfix", "Postfix Lilypond", "Insert or edit a LilyPond text to be post-fixed to the current note. This can be used for guitar fingerings, cautionary accidentals and much more. See LilyPond documentation.", lily_directive_postfix);
