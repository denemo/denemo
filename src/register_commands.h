...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "EditDirective"), "EditDirective", "Edit Directives", "Edit directives attached to chord/note at cursor.", edit_directive);
