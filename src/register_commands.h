...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "ToggleLyrics"), "ToggleLyrics", "Delete/Undelete Lyrics", "Deletes/Undeletes lyrics from current voice", toggle_lyrics);
