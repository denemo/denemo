...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "AttachLilyDirective"), "AttachLilyDirective", "Attach Lilypond", "Attach or edit attached LilyPond text (fixed to the current note). This can be used for guitar fingerings, cautionary accidentals and much more. See LilyPond documentation.", lily_directive_attach);
