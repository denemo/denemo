...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "InsertBlankOneHundredTwentyEighthNote"), "InsertBlankOneHundredTwentyEighthNote", "Insert Blank one hundred and twenty eighth Note", "No Tooltip yet", insert_blankchord_7key);
register_command(Denemo.map, gtk_action_group_get_action(action_group, "InsertBlankTwoHundredFiftySixthNote"), "InsertBlankTwoHundredFiftySixthNote", "Insert Blank two hundred and fifty sixth Note", "No Tooltip yet", insert_blankchord_8key);
...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "AddA"), "AddA", "Insert A","Inserts note A before note at cursor\nCursor determines which octave\nNote is inserted in the prevailing rhythm",  AddA);
...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "AddB"), "AddB", "Insert B","Inserts note B before note at cursor\nCursor determines which octave\nNote is inserted in the prevailing rhythm",  AddB);
...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "AddC"), "AddC", "Insert C","Inserts note C before note at cursor\nCursor determines which octave\nNote is inserted in the prevailing rhythm",  AddC);
...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "AddD"), "AddD", "Insert D","Inserts note D before note at cursor\nCursor determines which octave\nNote is inserted in the prevailing rhythm",  AddD);
...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "AddE"), "AddE", "Insert E","Inserts note E before note at cursor\nCursor determines which octave\nNote is inserted in the prevailing rhythm",  AddE);
...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "AddF"), "AddF", "Insert F","Inserts note F before note at cursor\nCursor determines which octave\nNote is inserted in the prevailing rhythm",  AddF);
...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "AddG"), "AddG", "Insert G","Inserts note G before note at cursor\nCursor determines which octave\nNote is inserted in the prevailing rhythm",  AddG);
