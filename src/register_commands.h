...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "RunEditScript"), "RunEditScript", "Edit Directive", "Run an edit script to edit the directive at the cursor.", edit_directive);
