...
register_command(Denemo.map, gtk_action_group_get_action(action_group, "EditKeysigDirective"), "EditKeysigDirective", "Edit Time Signature Directives", "Edit any directives attached to key signature.", edit_keysig_directive);
