;;;OrnamentSharp
(let* ((tag "OrnamentSharp")  (params OrnamentSharp::params) (data  (d-DirectiveGet-chord-data tag)) (direction "-") 
     (markup #f) (base-markup "\\tweak self-alignment-X #-1.5 \\tweak outside-staff-priority #50 -\\markup { \\tiny \\sharp }" ))
    (if data
        (begin
    ...
    (if (list?  params)
        ...
        (if (equal? params "edit")
            ...
            (ChordAnnotation tag  (string-append direction markup) #f LG-Sharp)))
