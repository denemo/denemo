...
(if (or (d-IsAppending) (d-Directive-chord? DenemoWholeMeasureRestTag))
 (let ((timesig #f))
    ...
    (if (not (d-Directive-chord? DenemoWholeMeasureRestTag))
        (d-InsertWholeRest)
        (Help::TimedNotice  (_ "<span font_desc=\"16\" foreground=\"blue\">Duration of whole measure rest has been re-calculated</span>")))
    ...
    (d-DirectivePut-chord-display DenemoWholeMeasureRestTag "1")
    (d-DirectivePut-chord-tx DenemoWholeMeasureRestTag 76)
