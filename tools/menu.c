struct name_and_function denemo_commands[] = {
  ...
  {NULL, "No Tooltip yet", N_("InsertTrebleClef"), "newcleftreble", N_("New Treble Clef")},
  {NULL, "No Tooltip yet", N_("InsertBassClef"), "newclefbass", N_("New Bass Clef")},
  {NULL, "No Tooltip yet", N_("Insertg8clef"), "newclefg8", N_("New G8 Clef")},
  {NULL, "No Tooltip yet", N_("InsertAltoClef"), "newclefalto", N_("New Alto Clef")},
  {NULL, "No Tooltip yet", N_("InsertTenorClef"), "newcleftenor", N_("New Tenor Clef")},
  {NULL, "No Tooltip yet", N_("InsertSopranoClef"), "newclefsoprano", N_("New Soprano Clef")},

  {NULL, "No Tooltip yet", N_("SetInitialTrebleClef"), "setcleftreble", N_("Set Treble Clef")},
  {NULL, "No Tooltip yet", N_("SetInitialBassClef"), "setclefbass", N_("Set Bass Clef")},
  {NULL, "No Tooltip yet", N_("SetInitialg8clef"), "setclefg8", N_("Set G8 Clef")},
  {NULL, "No Tooltip yet", N_("SetInitialAltoClef"), "setclefalto", N_("Set Alto Clef")},
  {NULL, "No Tooltip yet", N_("SetInitialTenorClef"), "setcleftenor", N_("Set Tenor Clef")},
  {NULL, "No Tooltip yet", N_("SetInitialSopranoClef"), "setclefsoprano", N_("Set Soprano Clef")},
  ...
  {NULL, "No Tooltip yet", N_("InsertCmaj"), "newkeysigcmaj", N_("Insert Cmaj")},
  {NULL, "No Tooltip yet", N_("InsertGmaj"), "newkeysiggmaj", N_("Insert Gmaj")},
  {NULL, "No Tooltip yet", N_("InsertDmaj"), "newkeysigdmaj", N_("Insert Dmaj")},
  {NULL, "No Tooltip yet", N_("InsertAmaj"), "newkeysigamaj", N_("Insert Amaj")},
  {NULL, "No Tooltip yet", N_("InsertEmaj"), "newkeysigemaj", N_("Insert Emaj")},
  {NULL, "No Tooltip yet", N_("InsertBmaj"), "newkeysigbmaj", N_("Insert Bmaj")},
  {NULL, "No Tooltip yet", N_("InsertFSharpmaj"), "newkeysigfsharpmaj", N_("Insert F# Major")},
  {NULL, "No Tooltip yet", N_("InsertCSharpmaj"), "newkeysigcsharpmaj", N_("Insert C# Major")},
  {NULL, "No Tooltip yet", N_("InsertFmaj"), "newkeysigfmaj", N_("Insert F Major")},
  {NULL, "No Tooltip yet", N_("InsertBflatmaj"), "newkeysigbflatmaj", N_("Insert Bb Major")},
  {NULL, "No Tooltip yet", N_("InsertEflatmaj"), "newkeysigeflatmaj", N_("Insert Eb Major")},
  {NULL, "No Tooltip yet", N_("InsertAflatmaj"), "newkeysigaflatmaj", N_("Insert Ab Major")},
  {NULL, "No Tooltip yet", N_("InsertDflatmaj"), "newkeysigdflatmaj", N_("Insert Db Major")},
  {NULL, "No Tooltip yet", N_("InsertGflatmaj"), "newkeysiggflatmaj", N_("Insert Gb Major")},
  {NULL, "No Tooltip yet", N_("InsertCflatmaj"), "newkeysigcflatmaj", N_("Insert Cb Major")},
  {NULL, "No Tooltip yet", N_("InsertAmin"), "newkeysigamin", N_("Insert A Minor")},
  {NULL, "No Tooltip yet", N_("InsertEmin"), "newkeysigemin", N_("Insert E Minor")},
  {NULL, "No Tooltip yet", N_("InsertBmin"), "newkeysigbmin", N_("Insert B Minor")},
  {NULL, "No Tooltip yet", N_("InsertFSharpmin"), "newkeysigfsharpmin", N_("Insert F# Minor")},
  {NULL, "No Tooltip yet", N_("InsertCSharpmin"), "newkeysigcsharpmin", N_("Insert C# Minor")},
  {NULL, "No Tooltip yet", N_("InsertGSharpmin"), "newkeysiggsharpmin", N_("Insert G# Minor")},
  {NULL, "No Tooltip yet", N_("InsertDSharpmin"), "newkeysigdsharpmin", N_("Insert D# Minor")},
  {NULL, "No Tooltip yet", N_("InsertASharpmin"), "newkeysigasharpmin", N_("Insert A# Minor")},
  {NULL, "No Tooltip yet", N_("InsertDmin"), "newkeysigdmin", N_("Insert D Minor")},
  {NULL, "No Tooltip yet", N_("InsertGmin"), "newkeysiggmin", N_("Insert G Minor")},
  {NULL, "No Tooltip yet", N_("InsertCmin"), "newkeysigcmin", N_("Insert C Minor")},
  {NULL, "No Tooltip yet", N_("InsertFmin"), "newkeysigfmin", N_("Insert F Minor")},
  {NULL, "No Tooltip yet", N_("InsertBflatmin"), "newkeysigbflatmin", N_("Insert Bb Minor")},
  {NULL, "No Tooltip yet", N_("InsertEflatmin"), "newkeysigeflatmin", N_("Insert Eb Minor")},
  {NULL, "No Tooltip yet", N_("InsertAflatmin"), "newkeysigaflatmin", N_("Insert Ab Minor")},

  //Functions to Set Initial Key Sig
  {NULL, "No Tooltip yet", N_("SetInitialCmaj"), "setkeysigcmaj", N_("Set Initial Keysig to C Major")},
  {NULL, "No Tooltip yet", N_("SetInitialGmaj"), "setkeysiggmaj", N_("Set Initial Keysig to G Major")},
  {NULL, "No Tooltip yet", N_("SetInitialDmaj"), "setkeysigdmaj", N_("Set D Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialAmaj"), "setkeysigamaj", N_("Set A Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialEmaj"), "setkeysigemaj", N_("Set E Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialBmaj"), "setkeysigbmaj", N_("Set B Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialFSharpmaj"), "setkeysigfsharpmaj", N_("Set F# Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialCSharpmaj"), "setkeysigcsharpmaj", N_("Set C# Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialFmaj"), "setkeysigfmaj", N_("Set F Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialBflatmaj"), "setkeysigbflatmaj", N_("Set Bb Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialEflatmaj"), "setkeysigeflatmaj", N_("Set Eb Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialAflatmaj"), "setkeysigaflatmaj", N_("Set Ab Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialDflatmaj"), "setkeysigdflatmaj", N_("Set Db Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialGflatmaj"), "setkeysiggflatmaj", N_("Set Gb Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialCflatmaj"), "setkeysigcflatmaj", N_("Set Cb Major as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialAmin"), "setkeysigamin", N_("Set A Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialEmin"), "setkeysigemin", N_("Set E Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialBmin"), "setkeysigbmin", N_("Set B Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialFSharpmin"), "setkeysigfsharpmin", N_("Set F# Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialCSharpmin"), "setkeysigcsharpmin", N_("Set C# Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialGSharpmin"), "setkeysiggsharpmin", N_("Set G# Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialDSharpmin"), "setkeysigdsharpmin", N_("Set D# Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialASharpmin"), "setkeysigasharpmin", N_("Set A# Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialDmin"), "setkeysigdmin", N_("Set D Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialGmin"), "setkeysiggmin", N_("Set G Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialCmin"), "setkeysigcmin", N_("Set C Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialFmin"), "setkeysigfmin", N_("Set F Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialBflatmin"), "setkeysigbflatmin", N_("Set Bb Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialEflatmin"), "setkeysigeflatmin", N_("Set Eb Minor as Initial Keysig")},
  {NULL, "No Tooltip yet", N_("SetInitialAflatmin"), "setkeysigaflatmin", N_("Set Ab Minor as Initial Keysig")},
  ...
  {NULL, "Menu:\\nBarlines and Repeat Barlines.", N_("Barlines"), NULL, N_("Barlines")},
