struct name_and_function denemo_commands[] = {
  ...
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert " NOTE0, N_("WholeNote"), "insert_chord_0key", NULL, NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert " NOTE1, N_("HalfNote"), "insert_chord_1key", NULL, NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert " NOTE2, N_("QuarterNote"), "insert_chord_2key", NULL, NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert " NOTE3, N_("EighthNote"), "insert_chord_3key", NULL, NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert " NOTE4, N_("SixteenthNote"), "insert_chord_4key", NULL, NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert " NOTE5, N_("ThirtysecondNote"), "insert_chord_5key", NULL, NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert " NOTE6, N_("SixtyfourthNote"), "insert_chord_6key", NULL, NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert " NOTE7, N_("OneHundredTwentyEighthNote"), "insert_chord_7key", NULL, NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert " NOTE8, N_("TwoHundredFiftySixthNote"), "insert_chord_8key", NULL, NULL},

  {CMD_CATEGORY_REST_ENTRY, NULL, "Insert " REST0 " rest", N_("InsertWholeRest"), "insert_rest_0key", "Insert a " REST0, NULL},
  {CMD_CATEGORY_REST_ENTRY, NULL, "Insert " REST1 " rest", N_("InsertHalfRest"), "insert_rest_1key", "Insert a " REST1, NULL},
  {CMD_CATEGORY_REST_ENTRY, NULL, "Insert " REST2 " rest", N_("InsertQuarterRest"), "insert_rest_2key", "Insert a " REST2, NULL},
  {CMD_CATEGORY_REST_ENTRY, NULL, "Insert " REST3 " rest", N_("InsertEighthRest"), "insert_rest_3key", "Insert a " REST3, NULL},
  {CMD_CATEGORY_REST_ENTRY, NULL, "Insert " REST4 " rest", N_("InsertSixteenthRest"), "insert_rest_4key", "Insert a " REST4, NULL},
  {CMD_CATEGORY_REST_ENTRY, NULL, "Insert " REST5 " rest", N_("InsertThirtysecondRest"), "insert_rest_5key", "Insert a " REST5, NULL},
  {CMD_CATEGORY_REST_ENTRY, NULL, "Insert " REST6 " rest", N_("InsertSixtyfourthRest"), "insert_rest_6key", "Insert a " REST6, NULL},

  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert a non-printing " REST0 " rest", N_("InsertBlankWholeNote"), "insert_blankchord_0key", "Insert a " REST0 " Spacer", NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert a non-printing " REST1 " rest", N_("InsertBlankHalfNote"), "insert_blankchord_1key", "Insert a " REST1 " Spacer", NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert a non-printing " REST2 " rest", N_("InsertBlankQuarterNote"), "insert_blankchord_2key", "Insert a " REST2 " Spacer", NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert a non-printing " REST3 " rest", N_("InsertBlankEighthNote"), "insert_blankchord_3key", "Insert a " REST3 " Spacer", NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert a non-printing " REST4 " rest", N_("InsertBlankSixteenthNote"), "insert_blankchord_4key", "Insert a " REST4 " Spacer", NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert a non-printing " REST5 " rest", N_("InsertBlankThirtysecondNote"), "insert_blankchord_5key", "Insert a " REST5 " Spacer", NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert a non-printing " REST6 " rest", N_("InsertBlankSixtyfourthNote"), "insert_blankchord_6key", "Insert a " REST6 " Spacer", NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert a non-printing " REST7 " rest", N_("InsertBlankOneHundredTwentyEighthNote"), "insert_blankchord_7key", "Insert a " REST7 " Spacer", NULL},
  {CMD_CATEGORY_NOTE_ENTRY, NULL, "Insert a non-printing " REST8 " rest", N_("InsertBlankTwoHundredFiftySixthNote"), "insert_blankchord_8key", "Insert a " REST8 " Spacer", NULL},
